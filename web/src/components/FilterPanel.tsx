  ...
  return (
    <div>
      ...
      <div className="relative">
        <button
          onClick={() => setOpen((o) => !o)}
          className="w-full text-left bg-[#11162a] border border-white/10 rounded-md text-xs px-2.5 py-1.5 text-ink-400 hover:border-white/20 transition-colors"
        >
          {t("filter.addFilter")}
        </button>
        {open && (
          <div className="absolute z-20 mt-1 w-full max-h-48 overflow-y-auto bg-[#1a2036] border border-white/15 rounded-md shadow-lg">
