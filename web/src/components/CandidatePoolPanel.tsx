      ...
      <div>
        ...
        <div className="flex items-center gap-2 mb-1.5">
          ...
          <input
            ...
            className="w-28 bg-[#11162a] border border-white/10 rounded-md text-xs px-2 py-1 text-ink-100 tabular-nums focus:outline-none focus:border-[var(--color-accent)]/50"
          />
